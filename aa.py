...
---------------------------------------------""" )
        ...
        if 'save-device' in ambil:
            try:
                ...
                my.close()
                print tutup + '[' + ungu + '+' + tutup + '] Login berhasil'
...
def dump():
    ...
    print
    mana_dump = raw_input(tutup + '[' + lime + 'Croot' + tutup + ']> ' + lime)
    if mana_dump == '':
        exit(tutup + '[' + merah + '!' + tutup + '] Exit' + tutup)
...
def hack():
    ...
    print tutup+"("+merah+"00"+tutup+") Back"
    print
    mana_hack = raw_input(tutup+"["+lime+"Croot"+tutup+"]> "+lime)
    if mana_hack =="":
	    exit(tutup+"["+merah+"!"+tutup+"] Exit"+tutup)
...
def bot():
    ...
    print tutup + '(' + merah + '00' + tutup + ') Back'
    print
    mana_bot = raw_input(tutup + '[' + lime + 'Croot' + tutup + ']> ' + lime)
    if mana_bot == '':
        exit(tutup + '[' + merah + '!' + tutup + '] Exit' + tutup)
...
def react_target():
    ...
    print
    emot = raw_input(tutup+"["+lime+"Croot"+tutup+"]> "+lime)
    if emot in ['1','01']:
	    tipe = "LIKE"
    elif emot in ['2','02']:
	    tipe = "LOVE"
...
def guard():
    ...
    print
    ha = raw_input(tutup + '[' + lime + 'Croot' + tutup + ']> ' + lime)
    if ha == '':
        exit(tutup + '[' + merah + '!' + tutup + '] Exit' + tutup)
    elif ha in ('1', '01'):
        aktif = 'true'
